...
Naliczanie punktów to jeden `select` + jeden `upsert` niezależnie od liczby typów (dziesiątki, zgodnie z NFR skali pojedynczego biura) — brak N+1, brak potrzeby kolejki/asynchroniczności przy tej skali.
