...
| S-03 | admin-adds-matches                      | Admin może dodać spotkania do turnieju z terminem                             | S-01, F-01      | FR-005                | done |
...
- **S-03: Admin może dodać spotkanie (element turnieju) wraz z terminem (data i godzina) rozegrania.** — Archived 2026-09-13 → `context/archive/2026-09-11-admin-adds-matches/`. Lesson: —.
